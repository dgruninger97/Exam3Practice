...
def run_test_zero_changer():
    ...
    # ------------------------------------------------------------------
    # Test 2:
    test2 = ([0] , [12, 55, 18, 30, 0], [4, 0, 0, 4, 4, 0])
    expected2 = ([1], [12, 55, 18, 30, 2], [4, 3, 4, 4, 4, 5])
    zero_changer(test2)
    print()
    print('Test 2:')
    ...
    # Test 3:
    test3 = ([400, 21, 0, 9], [0, 0, 3], [4, 4, 4],)
    expected3 = ([400, 21, 1, 9], [2, 3, 3], [4, 4, 4])
    zero_changer(test3)
    print()
    print('Test 3:')
